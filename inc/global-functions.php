...
/** Plugin Install ***/
function global_required_plugins() {
     ...
     */
    $config = array(
        'page_title'                      => __( 'Install Required Plugins', 'global' ),
        'menu_title'                      => __( 'Install Plugins', 'global' ),
        'installing'                      => __( 'Installing Plugin: %s', 'global' ),
        'oops'                            => __( 'Something went wrong with the plugin API.', 'global' ),
        ...
        'return'                          => __( 'Return to Required Plugins Installer', 'global' ),
        'dashboard'                       => __( 'Return to the dashboard', 'global' ),
        'plugin_activated'                => __( 'Plugin activated successfully.', 'global' ),
        'activated_successfully'          => __( 'The following plugin was activated successfully:', 'global' ),
        'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'global' ),
        'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'global' ),
        'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'global' ),
        'dismiss'                         => __( 'Dismiss this notice', 'global' ),
        'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'global' ),
    );

    tgmpa( $plugins, $config );

}
add_action( 'tgmpa_register', 'global_required_plugins' );
